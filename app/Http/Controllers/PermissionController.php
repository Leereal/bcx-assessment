...
class PermissionController extends Controller {
    public function index($role_id = '') {
        ...
        if ($role_id != '') {
            $permission_list = Permission::where("role_id", $role_id)
                ->pluck('permission')
                ->toArray();
        }
        ...
        $app = app();
        $routeCollection = FacadesRoute::getRoutes()->getRoutes();
        $routes = [];
        ...
        return view('permission.create', compact('permission', 'permission_list', 'role_id','roles'));
    ...
    public function store(Request $request) {
        ...
        DB::commit();
            ...
            DB::rollback();
            return Redirect::back()->withErrors(['message' => 'Failed To Save']);
        }
        return redirect()->route('permission.index')->with('success','Saved successfully');
    }
